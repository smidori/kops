...
properties([
  [$class: 'ParametersDefinitionProperty',
    parameterDefinitions: [
      ...
      stringParameter("AwsDefaultRegion","Amazon AWS Default to use AWS CLI commands (using the SDKs) and using AWS API operations."),
      stringParameter("KubernetesClusterName","Provide de cluster name to be created."),
      ...
      stringParameter("Zones", "Zones in which to run the cluster. If more than one, separate them with commas"),
      stringParameter("MasterInstanceType","Instance type (size) for masters EC2 instance"),
      stringParameter("MasterCount","Number of masters cluster EC2 instance", "1"),
      stringParameter("NodesInstanceType","Instance type (size) for nodes EC2 instance"),
      ...
      stringParameter("VpcID","Provide de ID of shared VPC"),
      stringParameter("NetworkCIDR","The Network CIDR from VPC provided before"),
